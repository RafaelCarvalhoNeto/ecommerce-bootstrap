        ...
        <div class="carousel-inner">
              ...
              <div class="modal-body">
                <form action="" method="post">
                  ...
                  <div class="form-group col-auto clearfix px-0">
                    <button type="submit" class="btn btn-dark float-right ml-2">Logar</button>
                    <button type="reset" class="btn btn-secondary float-right">Limpar</button>
                  </div>
                </form> 
              </div>
              <div class="modal-footer">
                  <small class="d-block w-100 text-muted">Ops! Ainda não tenho conta, quero <a href="#carouselModal" class="text-warning" role="button" data-slide="next">me cadastrar</a>.</small>
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item" id="carroselCadastroItem">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <small class="d-block w-100 text-muted">Ops! Já tenho conta, quero <a href="#carouselModal" class="text-warning" role="button" data-slide="prev">me logar</a>.</small></a>
              </div>
            </div>
          </div>
        ...
        if($cadastrou){
            ...
            '<div class="modal fade" id="aviso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-body">
                    <p class="alert alert-success">Usuário cadastrado com sucesso <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button></p>
            ...
            echo
            '<div class="modal fade show" id="aviso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <p class="alert alert-danger">Falha ao processar requisição</p>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
